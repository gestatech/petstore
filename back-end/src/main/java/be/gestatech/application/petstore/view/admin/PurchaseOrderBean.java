...
import be.gestatech.application.petstore.model.PurchaseOrder;
...
public class PurchaseOrderBean implements Serializable {
    ...
    private static final long serialVersionUID = -4177838651026016266L;
   ...
   /*
    * Support listing and POSTing back PurchaseOrder entities (e.g. from inside anHtmlSelectOneMenu)
    */
